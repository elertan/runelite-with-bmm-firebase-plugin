package net.runelite.client.plugins.crabmanmode.database;


import net.runelite.client.plugins.crabmanmode.UnlockedItemEntity;
import net.runelite.client.plugins.crabmanmode.UnlockedItemTableApi;
